...
<div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <div class="fadeIn first">
        <img src="../imgs/user.png"  width="50"/>
      </div>
  
      <!-- Login Form -->
      <form action="adduser.php" method="GET" id="userForm" >
        <input type="date" id="birthday" class="fadeIn second" name="birthday" placeholder="Birthday" max="2002-12-31" min="1920-01-01" Required>
        <input type="text" id="fname" class="fadeIn second" name="fname" placeholder="Full Name"  Required>
