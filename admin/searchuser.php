...
<!--Search Box-->
  <div class="div_search">
    <h3>Search user by its email</h3>

    <div class="col-md-6 col-lg-6 col-l1 mx-auto my-auto search-box">

            <form name="search-form" action= "userinf.php" method="POST">
            <div class="input-group form-container">
              <input type="text" name="email" id="email" class="search-input "required  placeholder="  Tap a valid email ..." autofocus="autofocus" autocomplete="off" >
